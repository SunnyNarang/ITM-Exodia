...
<div class="profileCard1" style="margin-bottom:50px">
                ...
                <div class="daytime">
			<?php if($_SESSION['roll']=="0915admin" or $_SESSION['roll']=="0915director") echo'	<a class="itsatte" data-toggle="modal" data-target="#admit_stu">Admit Students</a>'; ?>
				<a class="itsatte" onclick="reg_stu()">Register Students</a>
				<?php if($_SESSION['roll']=="0915admin" or $_SESSION['roll']=="0915director") echo'<a class="itsatte" onclick="import_excel()">Export Excel Sheet</a>'; ?>
