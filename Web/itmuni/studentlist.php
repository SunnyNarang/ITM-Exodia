...
$stmtb = $conn->prepare('SELECT image from login where roll=?');
$stmtb->bind_param("s", $studentroll);
$stmtb->execute();
$resultb = $stmtb->get_result();
while($rowb = $resultb->fetch_assoc()) {
$studentimage=$rowb['image'];
}
...
?>
	<div class="family" style="width:100%;margin:0;background:#fff;padding:10px">
			...
			<img src="img/<?php echo $studentimage; ?>" style="width:40px;border-radius:100%">
			</div>
