...
include('db.php');
$stmt = $conn->prepare('SELECT notice.id as id, notice.title as title, notice.body as body, notice.notice_date as n_date, teacher.roll as tea_roll, teacher.name as t_name FROM notice inner join teacher on teacher.roll=notice.t_id where notice.type="1" or notice.type="3" Order by notice.notice_date DESC LIMIT 10');
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <header class="codrops-header" style="padding:10px;margin-bottom:0px;text-align:justify">
				...
				<input required name="notice_type" id="" style="width: 100%;font-family: 'Titillium Web';font-size:15px;font-weight: 200;padding: 6px;margin-top: 2px;color: #555;border:1px solid #c0c0c0;border-radius: 2px;margin-bottom:10px">
				<span style="padding:0;font-size:15px;font-weight:800;text-align: left;font-family:titillium web">Title</span>
				<input required name="notice_title" id="admit_course" style="width: 100%;font-family: 'Titillium Web';font-size:15px;font-weight: 200;padding: 6px;margin-top: 2px;color: #555;border:1px solid #c0c0c0;border-radius: 2px;margin-bottom:10px">
				<span style="padding:0;font-size:15px;font-weight:800;text-align: left;font-family:titillium web">Description</span>
				<textarea required name="notice_description" id="admit_course" style="height:100px;width: 100%;font-family: 'Titillium Web';font-size:15px;font-weight: 200;padding: 2px;margin-top: 2px;color: #555;border-color: #ccc;border-radius: 3px;"></textarea>
