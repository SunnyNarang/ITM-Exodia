...
<span style="padding:0;font-size:15px;font-weight:800;text-align: left;">Select Branch</span>
				<select name="admit_branch" id="notes_course" style="width: 100%;font-family: 'Titillium Web';font-size:15px;font-weight: 200;padding: 2px;margin-top: 2px;color: #555;border-color: #ccc;border-radius: 3px;">
...
$(document).ready(function() {				
	$('select[name=admit_branch]').change(function() {
		var branch = $(this).val();
		var course = $('select[name=admit_course]').val();
		admitnosem(branch, course);
    });
});
</script>	