...
<span style="padding:0;font-size:15px;font-weight:800;text-align: left;">Select Class</span>
				<select name="notes_classs" id="notes_course" style="width: 100%;font-family: 'Titillium Web';font-size:15px;font-weight: 200;padding: 2px;margin-top: 2px;color: #555;border-color: #ccc;border-radius: 3px;">
...
$(document).ready(function() {				
	$('select[name=notes_classs]').change(function() {
		var classs = $(this).val();
		getnodate(classs);
    });
});
