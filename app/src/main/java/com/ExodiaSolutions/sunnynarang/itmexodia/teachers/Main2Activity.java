...
import com.ExodiaSolutions.sunnynarang.itmexodia.ViewAttendanceTeacher;
import com.ExodiaSolutions.sunnynarang.itmexodia.login;
import com.ExodiaSolutions.sunnynarang.itmexodia.students.Notice_Body;
import com.ExodiaSolutions.sunnynarang.itmexodia.students.Notice_Class;
        ...
        date = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear,
                ...
                if (noof % 2 == 0) {
                    ...
                    arrayList.clear();
                    noticeloader.cancel(true);
                    noticeloader = new NoticeLoader(Main2Activity.this);
...
*/
       ...
       // adapter=new RecyclerCustomAdapter(this,arrayList);
      ...
      //  readItems();
        ...
        if (isNetworkAvailable()) {
            ...
            handler.postDelayed(new Runnable()
            {
                ...
                public void run() {
                    ...
                    {noticeloader.cancel(true);
                        //Toast.makeText(Main2Activity.this, "Time OUT", Toast.LENGTH_SHORT).show();
        ...
        /*recyclerView.addOnItemTouchListener( new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            @Override public void onItemClick(View view, int position) {
                ...
                Intent in = new Intent(Main2Activity.this,Notice_Body.class);
...
/*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.std_action_settings) {
            ...
            Toast.makeText(this, "UnderProcess", Toast.LENGTH_SHORT).show();
...
*/
            ...
            Intent i = new Intent(this,SelectClass.class);
            i.putExtra("roll_teacher",roll);
            i.putExtra("name_teacher",name);
            startActivity(i);

        }
       /* else if (id == R.id.view_attendance) {
            Intent i = new Intent(this,ViewAttendanceTeacher.class);
            i.putExtra("roll",roll);
                        startActivity(i);

        }*/
        else if (id == R.id.upload_attendance) {
            Intent i = new Intent(this,UploadAttendance.class);
            i.putExtra("roll",roll);
            startActivity(i);

        }/*else if (id == R.id.view_notes) {
            Intent i = new Intent(this,SelectNotes.class);
            i.putExtra("roll",roll);
            startActivity(i);
    ...
    public class NoticeLoader extends AsyncTask<Void,Void,String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            if( Link.getInstance().getHashMapLink().containsKey("get_faculty_notice")){
                login_url = Link.getInstance().getHashMapLink().get("get_faculty_notice");
            }
            ...
            try{
                ...
                String post_data1 = URLEncoder.encode("roll", "UTF-8") + "=" + URLEncoder.encode(roll, "UTF-8");
...
public void markatt(View v){
    ...
    public void reports(View v){ Intent i = new Intent(this,Report.class);
        i.putExtra("roll",roll);
        startActivity(i);}
    public void uploadatt(View v){Intent i = new Intent(this,UploadAttendance.class);
        i.putExtra("roll",roll);
        startActivity(i);}
    public void changepass(View v){ showEditDialog2(roll);}
    public void logout(View v){ Intent i = new Intent(this,login.class);
        i.putExtra("remember_not",true);
        this.finish();
        startActivity(i);}
    public void developers(View v){Intent i = new Intent(Main2Activity.this,DeveloperPage.class);
