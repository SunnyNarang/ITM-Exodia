...
public class WaveView extends View {
    ...
    public  int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#e4892a");
    public  int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#e4892a");
    ...
    public  int mBehindWaveColor = DEFAULT_BEHIND_WAVE_COLOR;
    public  int mFrontWaveColor = DEFAULT_FRONT_WAVE_COLOR;
